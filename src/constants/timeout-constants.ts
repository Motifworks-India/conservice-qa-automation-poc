 ...
 */
export const NAVIGATION_TIMEOUT = 30 * 10000;

/**
 * Timeout constant for Playwright's test functions, set to 2400000 milliseconds (40 minutes).
 */
export const TEST_TIMEOUT = 60 * 60 * 1000;  // 24 hours in milliseconds
